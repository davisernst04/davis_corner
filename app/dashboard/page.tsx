      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground italic">
            Managing the collection of thoughts.
          </p>
        </div>
            ...
            <Table>
              <TableHeader className="bg-muted/50">
                <TableRow className="border-border">
                  <TableHead className="w-[40%] font-bold uppercase tracking-widest text-[10px]">
                    Title
                  </TableHead>
                        ...
                        >
                          <DropdownMenuItem asChild>
                            <Link
                              ...
                              className="flex items-center cursor-pointer font-bold text-xs uppercase tracking-widest"
                            >
                          ...
                          <AlertDialog>
                            <AlertDialogTrigger asChild>
                              <DropdownMenuItem
                                ...
                                className="text-destructive focus:text-destructive focus:bg-destructive/10 cursor-pointer font-bold text-xs uppercase tracking-widest"
                              >
                            ...
                            <AlertDialogContent className="bg-card border-border">
                              <AlertDialogHeader>
                                <AlertDialogTitle className="italic">
                                  Are you absolutely sure?
                                </AlertDialogTitle>
                                <AlertDialogDescription className="font-serif">
                                  This will permanently remove "{post.title}"
                                  from the archives. This action cannot be
                                  undone.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
                                <AlertDialogCancel className="font-bold text-xs uppercase tracking-widest">
                                  Cancel
                                </AlertDialogCancel>
                                <AlertDialogAction
                                  onClick={() => deletePost(post.id)}
                                  className="bg-destructive hover:bg-destructive/90 font-bold text-xs uppercase tracking-widest"
                                >
                                  Delete
                                </AlertDialogAction>
                              </AlertDialogFooter>
